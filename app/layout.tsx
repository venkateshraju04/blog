...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      <link rel="apple-touch-icon" sizes="76x76" href={`${basePath}/static/images/logo.jpg`} />
      <link rel="icon" type="image/png" sizes="32x32" href={`${basePath}/static/images/logo.jpg`} />
      <link rel="icon" type="image/png" sizes="16x16" href={`${basePath}/static/images/logo.jpg`} />
